export default function Hero() {
    return (
        <div className="flex flex-col">
            <div className="mb-10">
                <div className="absolute box-gradient w-[895px] h-[424px] right-0">
                   
                </div>

                <div className="absolute rect-grad w-[700px] xl:w-[1160px] h-[12px] mt-[320px]">

                </div>

                <div className="relative z-10 ml-32">
                        
                    <h1 className=" my-32 text-6xl lg:text-7xl font-bold leading-8 font-lexend text-[#24223C] pb-3">
            ...
            <div>
                ...
                <div className="lg:flex flex-row gap-16 relative lg:ml-[140px] lg:mx-[120px] mt-[109px] mb-20 items-center">
                    ...
                    <div className="lg:flex lg:flex-col gap-4 text-[#24223C]">
