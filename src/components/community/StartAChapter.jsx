    ...
    return (
       <div className="flex flex-col lg:flex-row min-[400px]:mx-12 lg:mx-32 my-32 gap-10">
            <div className="relative">
                ...
                <div className="absolute w-[164px] lg:w-full -top-[70px] lg:-top-[100px] left-[0px]">
                    <img className="" src="images/image-s-1.png" alt="" />
                </div>
                <div className="absolute w-[164px] lg:w-full -top-[70px] lg:-top-[100px] left-[140px] lg:left-[198px]">
                    <img className="" src="images/image-s-2.png" alt="" />
                </div>
                <div className="absolute w-[164px] lg:w-full z-10 top-[10px] lg:top-[20px] left-[15px] lg:left-[66px]">
                    <img className="" src="images/image-s-3.png" alt="" />
                </div>
                <div className="absolute w-[164px] lg:w-full z-10 top-[10px] lg:top-[20px] left-[155px] lg:left-[264px]">
            ...
            <div className="flex flex-col mx-4 lg:mx-0 gap-2 lg:gap-4 -mt-[34px]">
                ...
                <div className="text-base lg:text-lg font-inter text-[#24223C] pb-4">
                    ...
                    <div className="block lg:hidden">Ask questions, share, and network on our dedicated Discord server</div>
                </div>
