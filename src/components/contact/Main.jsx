export default function Main() {
    return (
        <div className="flex flex-col min-[400px]:flex-row mt-24 mb-32 items-center">
            <form action="" className="mx-4 lg:mx-20 font-inter p-8 bg-[#F9FCF4] flex-grow">
                <div className="grid">
                    <div>
            ...
            <div className="flex-grow-0 flex-shrink-0 min-[400px]:mr-32">
                <div className="flex">
