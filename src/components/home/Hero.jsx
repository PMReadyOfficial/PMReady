import Flower1 from "@Images/landingPage/banner/Flower1.jpg";
import Flower2 from "@Images/landingPage/banner/Flower2.jpg";
import Flower3 from "@Images/landingPage/banner/Flower3.jpg";
...
export default function Hero() {
  return (
    <div className="flex flex-col overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row justify-between">
        <div className="flex items-start flex-col lg:flex-row lg:gap-10 mb-14">
          <div className="ml-3 min-[400px]:ml-10 lg:ml-32 mt-10 lg:mt-20 font-lexend">
            <h3 className="text-lg lg:text-2xl font-bold text-[#9C9AB7]">
            ...
            <h1 className="text-5xl lg:text-7xl font-bold text-[#24223C] pb-3">
              ...
              <span className="text-5xl lg:text-7xl block text-[#FA9D74] pt-2">
                Management
              </span>
            </h1>
            <div className="CTA flex gap-3 mt-10 lg:text-2xl font-semibold">
              <button className="px-10 py-3 bg-[#023849] border-4 text-[#FEFDFF] border-[#023849] rounded-[100px]">
                Join us on Discord
              </button>
            </div>
          </div>
        ...
        <div className="mt-14 mr-3 hidden lg:block">
          ...
          <div className="flex flex-row ml-10">
            <div>
              <div className="relative -z-40 rect-grad1 w-[6px] h-[229px] -mt-[84px] ml-10 "></div>
              <svg
                className="z-0 ml-[6px] -mt-[71px]"
                xmlns="http://www.w3.org/2000/svg"
                width="75"
                height="44"
                viewBox="0 0 75 44"
              ...
              >
                <path
                  d="M0.47011 0.0804127C-1.2042 12.1409 1.50042 23.8011 9.04772 32.3127C16.595 40.8244 27.5682 44.6133 39.3142 43.9196C40.9885 31.8591 38.2839 20.1989 30.7366 11.6873C23.1893 3.17557 12.2161 -0.61333 0.47011 0.0804127Z"
                  fill="#9ADB67"
                />
                <path
                  d="M73.9357 0.0804127C75.61 12.1409 72.9054 23.8011 65.3581 32.3127C57.8108 40.8244 46.8376 44.6133 35.0916 43.9196C33.4173 31.8591 36.1219 20.1989 43.6692 11.6873C51.2165 3.17557 62.1897 -0.61333 73.9357 0.0804127Z"
                  fill="#9ADB67"
                />
              </svg>
              <div className="relative -ml-[50px] -mt-72 bg-[#3BCABE] w-[194px] h-[194px] rounded-full flex">
                <img
                  className="rounded-full justify-center items-center m-2"
                  src={Flower1}
                  alt=""
                ></img>
              </div>
            ...
            <div className="ml-32">
              ...
              <div className="relative -ml-[50px] -mt-80 bg-[#FA9D74] w-[194px] h-[194px] rounded-full flex">
                <img
                  className="rounded-full justify-center items-center m-4"
                  src={Flower2}
                  alt=""
                ></img>
              </div>
        ...
        <div className="ml-4 mb-11 -mt-5 min-[400px]:ml-10 block lg:hidden">
          ...
          <div className="flex flex-row">
            <div>
              <div className="relative -z-60 rect-grad1 w-[6px] h-[140px] -mt-[95px] ml-[50px]"></div>
              <svg
                className="-z-70 ml-[16px] -mt-[71px]"
                xmlns="http://www.w3.org/2000/svg"
                width="75"
                height="44"
                viewBox="0 0 75 44"
            ...
            <div className="ml-16">
              <div className="relative -z-60 rect-grad1 w-[6px] h-[140px] -mt-[95px]"></div>
              <svg
                className="-z-70 -ml-[34px] -mt-[100px]"
                xmlns="http://www.w3.org/2000/svg"
                width="75"
                height="44"
                viewBox="0 0 75 44"
              ...
              <div className="relative -ml-[54px] -mt-[196px] bg-[#FA9D74] w-[120px] h-[120px] rounded-full flex">
                <img
                  className="rounded-full justify-center items-center m-3"
                  src={Flower2}
                  alt=""
                ></img>
              </div>
            ...
            <div className="-ml-9">
              <div className="relative -z-60 rect-grad1 w-[6px] h-[140px] -mt-[95px] ml-10 "></div>
              <svg
                className="-z-70 ml-[6px] -mt-[71px]"
                xmlns="http://www.w3.org/2000/svg"
                width="75"
                height="44"
                viewBox="0 0 75 44"
      ...
      <div className="rect-grad w-full h-[12px] mb-4"></div>
    </div>
  );
}
