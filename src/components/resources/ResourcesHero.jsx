...
function Hero() {
    return (
        <div className="flex flex-col lg:flex-row mt-20 mx-20 lg:mx-32 content-center justify-center gap-5">
            <div className="w-[500px] text-center shrink flex flex-col gap-5 mx-auto self-center items-center">
